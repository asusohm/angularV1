...
export class UpdateCurrencyComponent implements OnInit {
  ...
  editRate(id:any){
    ...
    this.controller.getExchangeRate(id+"").subscribe(data => {
      ...
      this.buyPriceInput = data.buyPrice.price;
      this.sellPriceInput = data.sellPrice.price;
  ...
  dateChange(){
    ...
    this.dateInputHis = this.formatDateTime.formatDate(this.dateInputHis);
    console.log(this.dateInputHis);
    this.controller.getExchangeRateByDate(this.dateInputHis).subscribe(data =>{
  ...
  editAndupdateRate() {
    ...
    if(this.editStatus == true){
      this.controller.putExchangeRate(this.editID,this.buyPriceInput,this.sellPriceInput,this.dateReal, this.currencySelect + "", Authentication.getUsername()).subscribe(
        data => {
