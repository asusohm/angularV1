...
export class ReservationComponent implements OnInit {
  ...
  createQueue() {
    this.queueController.postQueue(this.baseAmount,this.baseCurrency,this.distCurrency,this.formatDate.formatDate(this.dateAppointment),"mem",1).subscribe(data=>{
      console.log(data);
