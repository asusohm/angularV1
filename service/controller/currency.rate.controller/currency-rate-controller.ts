...
export class CurrencyRateController {
    ...
    public getExchangeRateByDate(date:string):Observable<any>{
      return this.httpClient.get('//localhost:8080/exchange-rate/date/'+date);
    }
    ...
    public putExchangeRate(id:string,buyPriceInput:number,sellPriceInput:number,date:string,currencyCode:string,personalUser:string):Observable<any>{
      return this.httpClient.put('//localhost:8080/exchange-rate/'+id+'/'+buyPriceInput+'/'+sellPriceInput+'/'+currencyCode+'/'+personalUser,{
         "date":date
      });
    }
    ...
    public newCurrencyRate(buyPriceInput:number,sellPriceInput:number,date:string,currencyCode:string,personalUser:string):Observable<any>{
      return this.httpClient.post('//localhost:8080/exchange-rate/'+buyPriceInput+'/'+sellPriceInput+'/'+currencyCode+'/'+personalUser
      ,{       
        "date":date
      });  
